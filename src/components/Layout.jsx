  ...
  return (
    <motion.button
      ...
      style={{
        ...
        fontWeight: 500, color: active ? T.ink : T.muted,
    ...
    >
      ...
      <motion.span
        ...
        style={{
          position: "absolute", left: 0, bottom: -3, height: 1.5,
          width: "100%", background: T.accent, transformOrigin: "left",
          borderRadius: 2,
        }}
      />
    </motion.button>
      ...
      >
        <div
          style={{
            ...
            padding: "0 clamp(20px,5vw,40px)", height: 68,
...
{/* Logo */}
          ...
          >
            ...
            <span
              style={{
                ...
                fontWeight: 600, color: T.ink, letterSpacing: "-0.4px",
              }}
            >
          ...
          {!isDesktop && (
            <button
              ...
              style={{
                ...
                display: "flex", alignItems: "center", gap: 10, padding: 8, zIndex: 600,
              }}
            >
              <span
                style={{
                  fontFamily: "'Cabinet Grotesk', sans-serif", fontSize: 11,
                  fontWeight: 700, letterSpacing: "0.1em", color: T.muted,
                ...
                {[0, 1].map((i) => (
                  <motion.span
                    ...
                    style={{
                      ...
                      borderRadius: 1, marginLeft: i === 1 && !open ? "auto" : 0,
                    }}
                  />
                ))}
              </div>
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <div>
              <div style={{ display: "flex", flexDirection: "column", gap: 0, borderTop: `1px solid ${T.border}`, marginTop: 12 }}>
                {NAV_LINKS.map((l, i) => (
                  <motion.div
                    key={l}
                    ...
                    style={{
                      ...
                      display: "flex", alignItems: "baseline", gap: 18, padding: "16px 0",
                    }}
                  >
                    <span style={{
                      fontFamily: "'Cabinet Grotesk', sans-serif", fontSize: 12,
                      fontWeight: 600, color: T.muted, letterSpacing: "0.08em",
                    }}>
                      0{i + 1}
                    </span>
                    <button
                      ...
                      style={{
                        ...
                        fontSize: "clamp(32px,8vw,56px)", fontWeight: 600,
                        color: T.ink, letterSpacing: "-1.5px", lineHeight: 1.1,
                        flex: 1,
                      }}
                    >
                      {l}
            ...
            >
              <div>
                <p style={{ fontFamily: "'Cabinet Grotesk', sans-serif", fontSize: 14, color: T.ink, fontWeight: 500 }}>
                  info@kayvionlabs.com
                </p>
                <p style={{ fontFamily: "'Cabinet Grotesk', sans-serif", fontSize: 13, color: T.muted, marginTop: 4 }}>
                  Nairobi, Kenya · Remote worldwide
                </p>
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: 6, fontFamily: "'Cabinet Grotesk', sans-serif", fontSize: 12, color: T.muted }}>
...
<LogoImage size={26} />
            <span
              style={{
                fontFamily: "'Clash Display', sans-serif", fontSize: 17,
                fontWeight: 700, color: T.white, letterSpacing: "-0.4px",
              }}
            >
              Kayvion<span style={{ color: T.accent }}>Labs</span>
            </span>
          ...
          <a
            ...
            style={{
              ...
              background: "rgba(34,85,255,0.12)", border: "1px solid rgba(34,85,255,0.28)",
          ...
          <div style={{ display: "flex", gap: 8 }}>
            {[
              ...
              <a
                key={name} href={url} target="_blank" rel="noopener noreferrer" aria-label={name}
                style={{
                  width: 34, height: 34, border: "1px solid rgba(255,255,255,0.12)",
                  borderRadius: 8, background: "none", display: "flex",
        ...
        <div style={{ ...col }}>
          <p style={{
            fontFamily: "'Cabinet Grotesk', sans-serif", fontSize: 11, fontWeight: 700,
          ...
          {FOOTER_SERVICES.map((l) => (
            <button
              ...
              style={{
                ...
                color: "rgba(255,255,255,0.48)", fontFamily: "'Cabinet Grotesk', sans-serif",
                fontSize: 14, fontWeight: 500, cursor: "pointer",
                marginBottom: 12, padding: 0, textAlign: "left",
        ...
        <div style={{ paddingLeft: isNarrow ? 0 : 28 }}>
          ...
          <div style={{
            marginTop: 20, padding: "14px 16px", background: "rgba(255,255,255,0.04)",
            ...
            <p style={{
              ...
              Nairobi, Kenya<br />Remote worldwide
            </p>
          </div>
        </div>
      </div>
      ...
      <div style={{
        maxWidth: 1280, margin: "0 auto", padding: `28px clamp(20px,5vw,40px)`,
        borderBottom: `1px solid rgba(255,255,255,0.08)`,
        display: "flex", alignItems: "center", justifyContent: "space-between",
        flexWrap: "wrap", gap: 20,
      }}>
        <p style={{
          fontFamily: "'Clash Display', sans-serif", fontSize: isMobile ? 16 : 20,
          fontWeight: 700, letterSpacing: "-0.6px", color: T.white,
        }}>
        ...
        <motion.button
          ...
          onClick={() => scrollToSection("contact")}
          style={{
            cursor: "pointer", background: T.accent, color: T.white, border: "none",
            padding: "11px 24px", borderRadius: 100, fontFamily: "'Cabinet Grotesk', sans-serif",
            fontWeight: 700, fontSize: 14, display: "inline-flex", alignItems: "center",
      ...
      <div style={{
        maxWidth: 1280, margin: "0 auto", padding: `18px clamp(20px,5vw,40px)`,
        display: "flex", alignItems: "center", justifyContent: "space-between",
